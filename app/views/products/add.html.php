  ...
  <div class="add_product">
      <h2>添加商品</h2>
          ...
          <ul>
              ...
              <!--li class="text_nums">
                  <?=$this->form->field(['showed' => '揭晓时间']);?>
              </li-->
              <li class="text_nums">
                  <?=$this->form->field(['images' => '图片'], ['style' => 'display:none', 'template' =>'<div>{:label}<dl class="add_p_img"><dd class="insert_bottom">添加<input id="upload" type="file" name="file" multiple></dd></dl><input class="none" name="img" readonly="readonly">']); ?>
