   ...
   <h2>晒单<a href="/shares/share" class="return_list">返回列表</a></h2>
    ...
    <ul>
      ...
      <li class="share_edit">
        <div>
          <label>内容</label>
          <textarea id="content" name="content" style="height:300px;width:750px;"></textarea>
      </li>
      <li>
        <div class="bottom_side">
            <input type="hidden" value="<?php echo $h($share['periodId']); ?>" name="period_id"/>
            <input type="hidden" value="<?php echo $h($share['productId']); ?>" name="product_id"/>
