...
<div class="user_content">
  ...
  <div class="add_product">
      <h2>添加商品</h2>
          ...
          <ul>
              <li class="text_nums">
                  <?php echo $this->form->field(['title' => '名称']); ?>
              </li>
              <li class="text_nums">
                  <?php echo $this->form->field(['feature' => '特性']); ?>
              </li>
              <li class="text_nums">
              ...
              <!--li class="text_nums">
                  <?php echo $this->form->field(['showed' => '揭晓时间']); ?>
              </li-->
              <li class="text_nums">
                  <?php echo $this->form->field(['images' => '图片'], ['style' => 'display:none', 'template' =>'<div>{:label}<dl class="add_p_img"><dd class="insert_bottom">添加<input id="upload" type="file" name="file" multiple></dd></dl><input class="none" name="img" readonly="readonly">']); ?>
    
                  
              </li>
              <li class="content_li">
                  <?php echo $this->form->field(['content' => '详情'], ['type' => 'textarea', 'id' => 'content']); ?>
              </li>
              <li></li>
              <li></li>
              <li>
