        ...
        <ul class="order">
            ...
            ?>
                <li class="end">
                    ...
                    <p> 总需 <span class="color"><?php echo $cart['person']; ?></span> 人次参与，还剩 <span><?php echo $cart['remain']; ?></span> 人次</p>
                    ...
                    <dl class="add">
                        <dd>
                            <input id="txtNum<?php echo $cart['id']; ?>" name="num" type="text" maxlength="7" value="<?php echo $cart['quantity']; ?>" class="amount" onpaste="return false" disabled="disabled" />
                        </dd>
